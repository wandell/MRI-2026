...
Magnets, coils, computers, whatever
...
Fourier Transform (k-space), Sampling issues, Distortions

Reconstruction principles; parallel imaging; multiplexing (mux).

## Brain components 

Cell types, Vasculature

## Functional signals

fMRI (not bold); visual field maps, functional specializations, other topics

## Data analysis methods

time series, beta-weights, other ...

## Diffusion 

## Quantitative MRI topics

Multi-echo quantification. Correcting for coil
