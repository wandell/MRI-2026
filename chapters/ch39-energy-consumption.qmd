...
![Ion channels and the sodium-potassium pump in the neuronal membrane, alongside a pie chart breaking down the components of spike- and sub-threshold-related energy cost (spike restoration, sub-threshold restoration, and steady-state maintenance) (Huettel et al., *Functional Magnetic Resonance Imaging*, 2e).](images/ch39/energy-consumption-overview.png){#fig-ch39-energy-consumption-overview fig-alt="Diagram of a neuronal membrane showing an ion channel and a sodium-potassium pump moving Na+ out and K+ in using ATP, alongside a pie chart with slices for spike restoration (47%), sub-threshold restoration (34%), steady-state (13%), and two smaller 3% slices."}
