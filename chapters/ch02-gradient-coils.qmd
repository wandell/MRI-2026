...
<!--
Note: the image filenames in images/ch02/ were renamed to match their contents (verified by
opening each one). The old names were assigned out of order because several consecutive slides
share a title — "Generation of a static magnetic field (B0)" covers the Helmholtz diagram, the
Helmholtz photograph, AND the solenoid; "Energy solution: superconducting magnets" covers two more
— so there was nothing in the titles to disambiguate them. Labels were updated to match.

TODO (Brian): still open — Part 1 labels do not carry the chapter prefix used from Part 2 onward
(#fig-b0-solenoid rather than #fig-ch02-b0-solenoid). Deferred so ch01-ch04 can be migrated
together rather than leaving a mixed convention.
-->


## Main Field and Gradient-Coil Overview

![Magnetic-field units and the scientists whose names they bear: Ørsted, Tesla, and Gauss.](images/ch02/magnetic-field-units-scientists.png){#fig-magnetic-field-units-scientists fig-alt="Slide titled Magnetic field units, showing reference field strengths and portraits of Hans Ørsted, Nikola Tesla, and Carl Friedrich Gauss."}
...
![Magnetic-field unit conversions for magnetic field strength ($H$) and magnetic flux density ($B$).](images/ch02/magnetic-field-unit-conversions.png){#fig-magnetic-field-unit-conversions fig-alt="Table of magnetic-field units and conversions, including oersted, ampere per meter, gauss, and tesla."}
...
![A laboratory Helmholtz pair: two coils of equal radius, separated by one radius, with the schematic shown below the photograph.](images/ch02/b0-helmholtz-pair-photo.png){#fig-b0-helmholtz-pair-photo fig-alt="Photograph of a laboratory Helmholtz pair — two coaxial copper coils on a bench — with a small Helmholtz-pair diagram shown below it."}

### The Solenoid Design

![A solenoid: many closely spaced turns of wire arranged around a cylindrical form (Huettel et al., *Functional Magnetic Resonance Imaging*, 2e).](images/ch02/b0-solenoid.png){#fig-b0-solenoid fig-alt="Slide illustrating a solenoid with many turns wrapped around a cylindrical form and field lines through its center."}
...
![A cutaway view of the scanner, showing how the components nest: the main magnet on the outside, the gradient coils inside it, the RF coil closest to the patient, and the patient table.](images/ch02/gradient-coils-scanner-cutaway.png){#fig-gradient-coils-scanner-cutaway fig-alt="Cutaway diagram of an MRI scanner labeling the magnet, gradient coils, radiofrequency coil, patient, and patient table."}

@fig-gradient-coils-scanner-cutaway puts the whole instrument together. Working outward from the subject: the RF coil that transmits and receives the signal (@sec-rf-coils-overview), then the three gradient coils that encode position, then the superconducting main magnet that supplies $B_0$. Each layer of that diagram corresponds to a section of this part of the book.
...
![New gradient coil delivered for insertion into the magnet bore. You can see the lines suggesting the saddle-windings.](images/ch02/gradient-coil-new-insertion.png){#fig-gradient-coil-new-insertion fig-alt="Photo of a large cylindrical gradient coil wrapped in plastic, being moved into position at the CNI."}
...
![The main gradient coil is being removed from the CNI scanner during an upgrade to the Ultra High Performance (UHP) design.](images/ch02/gradient-coil-removal-cni.png){#fig-gradient-coil-removal-cni fig-alt="Photo of the existing gradient coil being withdrawn from the scanner bore using an extraction tool."}
:::
