...
## Longitudinal net magnetization recovery (T1)

![Longitudinal net magnetization recovery (T1).](images/ch07/example-longitudinal-relaxation.png){#fig-ch07-example-longitudinal-relaxation}
...
## The T1-contrast: white is brighter than gray
