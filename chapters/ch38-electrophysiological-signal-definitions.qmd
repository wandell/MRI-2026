...
![Linear systems properties illustrated with BOLD responses: the top row shows scaling (proportionally larger responses to proportionally larger neural inputs), and the bottom row shows superposition (responses to inputs at different times summing together).](images/ch38/linear-systems-scaling-superposition.png){#fig-ch38-linear-systems-scaling-superposition fig-alt="Six small line plots of BOLD signal intensity versus time in two rows, the top row showing three impulse responses of increasing amplitude, the bottom row showing two separate impulse responses and their sum."}
