...
With these three candidate signals defined — spikes, LFP, and MUA — the next chapters ask which one actually predicts the BOLD response, starting with the energy costs of the underlying biophysical processes and then turning to the Logothetis experiments that measured all of these signals simultaneously with fMRI.
