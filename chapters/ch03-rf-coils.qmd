...
![RF coils transmit excitation and receive the MR signal.](images/ch03/rf-coils-intro.png){#fig-ch03-rf-coils-intro fig-alt="Title slide for the RF coils section, showing the RF Coils for MRI textbook cover and a photo of Stanford's engineering quad."}
...
![Phased-array head coils: comparing 12-channel and 32-channel configurations (Kaza et al., JMRI, 2011).](images/ch03/rf-phased-array-head-coils.png){#fig-ch03-rf-phased-array-head-coils fig-alt="Diagrams showing the element layouts of a 12-channel and a 32-channel phased-array head coil."}
...
![High-channel-count head coils developed at the University of Minnesota for ultra-high-field imaging.](images/ch03/rf-head-coil-minnesota.png){#fig-ch03-rf-head-coil-minnesota fig-alt="Six-panel figure showing head coil components, element arrays, and the assembled coil being worn by a subject."}

## Close-up: 64-channel coil (Stockmann/MGH)

![The 64-channel head coil project at Stanford: assembled by Kawin Setsompop's group, Adam Kerr, and Jason Stockmann from MGH.](images/ch03/rf-head-coil-stanford-project.png){#fig-ch03-rf-head-coil-stanford-project fig-alt="Photo of a partially assembled 64-channel head coil with many small coil elements visible, next to a workbench setup."}
:::
...
![Nova Medical: a leading commercial manufacturer of high-performance phased-array RF coils for research MRI.](images/ch03/rf-nova-medical.png){#fig-ch03-rf-nova-medical fig-alt="Screenshot of the Nova Medical website with the headline 'Leaders in High Field MRI Coil Engineering'. Text notes that many research sites including the CNI and Lucas Center use Nova coils."}
...
![Comparison of brain images acquired with surface, volume (birdcage), and phased-array RF coils (Huettel et al., *Functional Magnetic Resonance Imaging*, 2e).](images/ch03/rf-coil-images-comparison.png){#fig-ch03-rf-coil-images-comparison fig-alt="Three brain MR images labeled A (surface coil), B (volume coil), and C (phased-array coil), showing differences in spatial coverage and signal uniformity."}
