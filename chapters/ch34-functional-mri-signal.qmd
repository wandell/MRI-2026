...
# Discovery of the functional MRI signal
...
![Blood oxygenation affects T2 but not T1: 1/T2 and 1/T1 relaxation rates plotted against percent oxygenated hemoglobin, showing 1/T2 decreasing substantially with oxygenation while 1/T1 stays flat (Huettel et al., *Functional Magnetic Resonance Imaging*, 2e, Fig. 7.1).](images/ch34/t2-oxygenation-relaxation-plot.png){#fig-ch34-t2-oxygenation-relaxation-plot fig-alt="Scatter plot of relaxation rate versus percent oxygenated hemoglobin, with a steep downward trend for 1/T2 and a flat, near-zero line for 1/T1." fig-cap-location="margin"}
