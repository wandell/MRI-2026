...
% This tutorial illustrates the nature of diffusion of water in the presence 
% of barriers, such as the cell membranes. This is the situation we find when 
% we measure diffusion weighted images (DWI). 
% 
% The statistical issues involved in analyzing these data, and the computational 
...
% move in a homogeneous substrate (pure water). The coefficient value depends 
% on the water temperature (T) and the atmospheric pressure (P).  
% 
% Krynicki, Green & Sawyer (1978) define the relationship (Pressure and temperature 
% dependence of self-diffusion in water. Faraday Discuss. Chem. Soc., 66, 199 
% - 208.).  We use the Krynicki formula to calculate the diffusion coefficient 
% at various temperatures. 
% 
% The  units of this formula are self-diffusion of water ($\frac{{\textrm{um}}^2 
% }{\textrm{ms}}$) given the temperature T (in Centigrade) and the pressure P 
% (in kPa).
...
% at body temperature in Denver compared to Palo Alto, which is about at sea level?
% 
